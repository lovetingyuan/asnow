    ...
    return (function() {
    ...
    })()(
        {
            ...
            7: [
                ...
                {
                    '../../utils/mixin': 24,
                    '../location-info/tokenizer-mixin': 12,
                    './mixin-base': 6,
                    './tokenizer-mixin': 9
                }
            ],
            8: [
                ...
                { '../../utils/mixin': 24, '../position-tracking/preprocessor-mixin': 13, './mixin-base': 6 }
            ],
            9: [
                function(require, module, exports) {
                    'use strict';
                ...
                { '../../utils/mixin': 24, './mixin-base': 6, './preprocessor-mixin': 8 }
            ],
            10: [
                function(require, module, exports) {
                    'use strict';
            ...
            12: [
                ...
                { '../../tokenizer': 19, '../../utils/mixin': 24, '../position-tracking/preprocessor-mixin': 13 }
            ],
            13: [
                function(require, module, exports) {
                    'use strict';
            ...
            16: [
                ...
                },
                {
                    ...
                    '../common/foreign-content': 3,
                    '../common/html': 4,
                    '../common/unicode': 5,
                    '../extensions/error-reporting/parser-mixin': 7,
                    '../extensions/location-info/parser-mixin': 11,
                    '../tokenizer': 19,
                    '../tree-adapters/default': 22,
                    '../utils/merge-options': 23,
                    '../utils/mixin': 24,
                    './formatting-element-list': 15,
                    './open-element-stack': 17
                }
            ],
            17: [
                function(require, module, exports) {
            ...
            19: [
                ...
                { '../common/error-codes': 2, '../common/unicode': 5, './named-entity-data': 20, './preprocessor': 21 }
            ],
            20: [
                function(require, module, exports) {
                    'use strict';
            ...
            21: [
                ...
                { '../common/error-codes': 2, '../common/unicode': 5 }
            ],
            22: [
                function(require, module, exports) {
                    'use strict';
