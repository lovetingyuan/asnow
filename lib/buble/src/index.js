...
export function transform(source, options = {}) {
	...
	options._varsMap = Object.create(null);
	if (!options.objectAssign) {
		options.objectAssign = 'Object.assign';
	}
	const transformed = new Program( source, ast, transforms, options ).export( options );
	transformed.vars = Object.keys(options._varsMap);
	transformed.templateLiteral = !!options._templateLiteral;
	return transformed;
}
